...
/// <summary>
///     Adapts any Fisher <see cref="ISerializer" /> to the dialect-neutral
...
///     shared <c>Weasel.Core.ISerializer</c> members every Fisher serializer already carries.
/// </summary>
internal sealed class StorageSerializerAdapter : IStorageSerializer
{
    ...
    /// <summary>
    ///     STJ-only Fisher has no type-metadata pollution to strip; "clean" JSON is plain JSON.
    /// </summary>
    ...
    /// <summary>
    ///     Fisher binds JSON as string parameter values throughout (SQLite stores JSON as TEXT and the json1 functions
    ///     accept text input), so this stays dialect-neutral.
    /// </summary>
