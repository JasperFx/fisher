...
**2181 tests green on net9.0 and net10.0** — 2126 in
`Fisher.Tests`, 36 in `Fisher.AspNetCore.Tests` and 19 in `Fisher.EntityFrameworkCore.Tests`. 572 of
them are shared cross-store compliance tests — 489 event sourcing and 83 document. On JasperFx **2.69.3** / Weasel **9.32.0**.
...
`JasperFx.Events.ComplianceTests` 2.69.3 ships 56 suites; Fisher enrolls **55 of them, 572 tests**.
