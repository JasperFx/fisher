...
>
> Fisher passes **all 56 suites and 583 tests** it enrolls from `JasperFx.Events.ComplianceTests`,
> the shared cross-store suite Marten and Polecat also enroll in, alongside its own 2,165.
>
